...
Run: ``PYTHONPATH=.:scripts uv run python scripts/validation/validate_v8.py``.
"""
import numpy as np
...
def run(seed):
    econ = Economy(Config.v8(n_firms_c=NC, n_firms_k=NK, n_households=NH,
...
print(f"§4 VALIDATION -- Config.v8 (full stack + margin credit), {NC}C/{NK}K/{NH}H, "
