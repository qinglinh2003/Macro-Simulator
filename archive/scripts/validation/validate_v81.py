...
Run: ``PYTHONPATH=.:scripts uv run python scripts/validation/validate_v81.py``.
"""
import numpy as np
...
def run(seed):
    econ = Economy(Config.v81(n_firms_c=NC, n_firms_k=NK, n_households=NH,
...
print(f"§4 VALIDATION -- Config.v81 (v8 + Gibrat growth), {NC}C/{NK}K/{NH}H, "
