...
Run: ``PYTHONPATH=.:scripts uv run python scripts/validation/validate_v82.py``.
"""
import numpy as np
...
def run(seed):
    econ = Economy(Config.v82(n_firms_c=NC, n_firms_k=NK, n_households=NH,
...
print(f"§4 VALIDATION -- Config.v82 (v8.1 + adaptive portfolio), {NC}C/{NK}K/{NH}H, "
