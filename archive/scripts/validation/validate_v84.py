...
Run: ``PYTHONPATH=.:scripts uv run python scripts/validation/validate_v84.py``.
"""
import numpy as np
...
def run(seed):
    econ = Economy(Config.v84(n_firms_c=NC, n_firms_k=NK, n_households=NH,
...
print(f"§4 VALIDATION -- Config.v84 (v8.1 + weakened q-investment), {NC}C/{NK}K/{NH}H, "
