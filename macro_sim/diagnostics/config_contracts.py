...
def _firm_contracts() -> Mapping[str, Mapping[str, Any]]:
    ...
    return {
        ...
        "config.entry_beta": {
            ...
            "rationale": "Entry sensitivity scales the number of consumption-firm entrants generated by a positive median excess return. A shared zero hurdle and wider entry cap expose the coefficient without overwriting the audited treatment.",
        },
        "config.entry_hurdle": {
            "status": "screening_ready",
            "values": (0.0, 0.000268),
