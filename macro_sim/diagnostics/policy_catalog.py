...
LEVER_PROXIMAL_METRICS: Mapping[str, tuple[str, ...]] = MappingProxyType({
    ...
    "fiscal_uses_national_accounts_gdp": ("metric.source.m4.government_spending", "metric.economy.na.nominal_gdp"),
    "bond_finance_frac": ("metric.source.m6.bond_issuance",),
    "bond_coupon": ("metric.source.m6.bond_coupon_paid", "metric.source.m6.bond_issuance"),
    "bond_maturity": ("metric.source.m6.bond_redemption", "metric.source.m6.bond_issuance"),
    "omo": ("metric.source.m5.omo_flow", "metric.source.m5.total_reserves"),
    ...
    "lolr": ("metric.source.m5.lolr_advances", "metric.source.m5.bank_failures"),
    "bank_capital_constraint": ("metric.source.m5.new_credit", "metric.source.m5.total_bank_capital"),
    ...
    "bank_resolution_fund": ("metric.source.m5.resolution_cost", "metric.source.m5.bank_failures"),
    ...
    "margin_max": ("metric.source.m6.margin_originated", "metric.source.m6.margin_principal"),
    ...
    "mortgage_dsti_cap": ("metric.source.m8.housing.mortgage_originations", "metric.source.m8.housing.mortgage_principal_originated"),
    "mortgage_stress_rate_addon": ("metric.source.m8.housing.mortgage_originations",),
    "mortgage_risk_weight": ("metric.source.m8.housing.mortgage_originations", "metric.source.m5.total_bank_capital"),
    "mortgage_min_capital_ratio": ("metric.source.m8.housing.mortgage_originations", "metric.source.m5.total_bank_capital"),
    ...
    "housing_permits": ("metric.source.m8.housing.permits_used", "metric.source.m8.housing.dwellings_completed"),
    ...
    "housing_in_wealth_tax": ("metric.source.m8.housing.housing_wealth_tax_paid",),
    ...
    "deficit_u_cap": ("metric.source.m4.government_consumption", "metric.source.m4.government_deficit"),
    ...
    "household_bankruptcy": ("metric.source.m6.household_bankruptcies", "metric.source.m6.margin_writeoffs"),
    "rental_eviction_arrears": ("metric.source.m8.housing.evictions", "metric.source.m8.housing.rent_unpaid"),
    "bank_migrate_on_failure": ("metric.source.m5.bank_failures", "metric.source.m5.new_credit"),
    "unified_bank_rwa": ("metric.source.m5.new_credit", "metric.source.m5.total_bank_capital"),
    "firm_credit_min_dscr": ("metric.source.m5.firm_dscr_credit_shortfall", "metric.source.m5.new_credit"),
    "regulatory_firm_capital_haircut": ("metric.source.m5.new_credit", "metric.source.m5.firm_dscr_credit_shortfall"),
    "regulatory_firm_inventory_haircut": ("metric.source.m5.new_credit", "metric.source.m5.firm_dscr_credit_shortfall"),
    "land_fee_share": ("metric.source.m8.housing.land_fee_paid", "metric.source.m8.housing.dwellings_completed"),
    "land_fee_stock_elasticity": ("metric.source.m8.housing.land_fee_paid", "metric.source.m8.housing.dwellings_completed"),
