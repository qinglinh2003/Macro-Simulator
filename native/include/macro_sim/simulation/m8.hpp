...
struct MortgageRecord final {
    ...
    bool underwriting_applied{false};
    double dsti_cap_at_origination{0.0};
    double stress_rate_addon_at_origination{0.0};
...
struct HousingMetrics final {
    ...
    double mortgage_applications{0.0};
    double mortgage_underwriting_applications{0.0};
    ...
    double housing_wealth_tax_base_included{0.0};
    double transfer_tax_paid{0.0};
    double land_fee_paid{0.0};
    double land_fee_assessments{0.0};
    double land_fee_share_applied{0.0};
    double land_fee_stock_elasticity_applied{0.0};
