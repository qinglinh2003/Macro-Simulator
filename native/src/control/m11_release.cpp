...
M11ReleaseService::trigger_samples(const M11ReleaseStream &stream, EconomyId economy,
    ...
    const auto capital_outflow =
        latest_release(stream, economy, "shock_capital_outflow_pressure", as_of);
    ...
    return {
        ...
        {"shock_trade_severity",
         maximum_optional({import_shock, export_shock, capital_outflow})},
