...
std::string_view shock_kind_id(macro_sim::simulation::ShockKind kind) noexcept {
    ...
    case ShockKind::capital_outflow_pressure:
        return "capital_outflow_pressure";
    }
    return "unknown";
}
...
#undef MACRO_SIM_BIND_HOUSING_INPUT
    ...
    nb::enum_<macro_sim::simulation::ShockKind>(module, "ShockKind")
        ...
        .value("CAPITAL_OUTFLOW_PRESSURE",
               macro_sim::simulation::ShockKind::capital_outflow_pressure);
