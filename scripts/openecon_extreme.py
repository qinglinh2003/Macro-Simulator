...
FIX_PACKAGE = dict(builder_demand_price_gain=2.0, builder_inventory_buffer=3.0,
                   builder_land_fee_credit=True, housing_demand_step=0.02)
...
def scenario(name):
    ...
    n, pops, years, overrides, wo = _scenario_base(name)
