#!/usr/bin/env python3
"""Verify that an M6 source distribution contains its offline inputs."""
...
REQUIRED_SUFFIXES = {
    ...
    "schemas/m6/performance_budget.json",
    "tools/m6/check.py",
...
def main() -> int:
    ...
    with tarfile.open(sdist, mode="r:gz") as archive:
        ...
        if missing:
            raise ValueError(
                f"source distribution omits M6 inputs: {missing}"
            )
    print("M6 source artifact smoke: passed")
    return 0
