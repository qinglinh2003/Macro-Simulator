#!/usr/bin/env python3
"""Verify that an M7 source distribution contains its offline inputs."""
...
REQUIRED_SUFFIXES = {
    ...
    "schemas/m7/performance_budget.json",
    "tools/m7/check.py",
...
def main() -> int:
    ...
    with tarfile.open(sdist, mode="r:gz") as archive:
        ...
        if missing:
            raise ValueError(
                f"source distribution omits M7 inputs: {missing}"
            )
    print("M7 source artifact smoke: passed")
    return 0
