#!/usr/bin/env python3
"""Verify that an M9 source distribution contains its offline inputs."""
...
REQUIRED_SUFFIXES = {
    ...
    "schemas/m9/performance_budget.json",
...
def main() -> int:
    ...
    with tarfile.open(sdist, mode="r:gz") as archive:
        ...
        if missing:
            raise ValueError(
                f"source distribution omits M9 inputs: {missing}"
            )
    print("M9 source artifact smoke: passed")
    return 0
